...
<body>
    <form name = "form1" id="form1" action="file_ghi.php" method="post">
        <table width="500" border="0" align="center" cellpadding="2" bgcolor="#DB95B8">
            ...
            <tr>
                <td>
                    <label for="">
                        <input type="submit" name="Submit" class="Submit" id="Submit" value="Đọc và ghi file">
                    </label>
                </td>
            </tr>
        </table>
    ...
    <?php
        if(isset($_POST['ten_file']) && isset($_POST['noidung'])){
            ...
            while(!feof($file)){
                ...
                echo nl2br($noidung); // hàm cho xuống dòng
...
<!-- Hàm fwrite có 2 tham số <tên file, nội dung>
     khi mở file ở chế độ w: - Chưa tồn tại: thì tạo mới
                             - Tồn tại: mở file
     while trong lúc nội dung file chưa đọc hết (end of file) thì vẫn đọc file.
